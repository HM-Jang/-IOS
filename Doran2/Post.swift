...
class Post{
    ...
    init(id:Int, name:String, sdate:String, edate:String, phone:String, homepage:String, place:String, address1:String, address2:String, content:String, content_detail:String, thumb:String, thumb_detail:String, thumb_map:String, category_age_id:Int, category_event_id:Int){
